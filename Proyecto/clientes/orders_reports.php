            ...
            <div class="row">
                <div class="col">
                    <div class="card shadow">
                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush">
                                <thead class="thead-light">
                                    <tr>
                                        <th class="text-success" scope="col">Imagen del menú</th>
                                ...
                                <tbody>
                                    ...
                                    $ret = "SELECT * FROM  rpos_orders WHERE customer_id ='$customer_id' ORDER BY `created_at` DESC LIMIT $empieza, $por_pagina";
                                    ...
                                    while ($order = $res->fetch_object()) {
                                        ...
                                        $ret_prod = "SELECT prod_img FROM rpos_products WHERE prod_id = '$prod_id'";
                        ...
                        <?php
                        $pag_query = "SELECT * FROM rpos_orders WHERE customer_id ='$customer_id'";
