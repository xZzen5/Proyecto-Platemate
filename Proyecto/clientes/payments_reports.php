            ...
            <div class="row">
                <div class="col">
                    <div class="card shadow">
                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush">
                                ...
                                <tbody>
                                    ...
                                    $ret = "SELECT * FROM  rpos_payments WHERE customer_id ='$customer_id' ORDER BY `created_at` DESC LIMIT $empieza, $por_pagina";
                        ...
                        <?php
                        $pag_query = "SELECT * FROM rpos_payments WHERE customer_id ='$customer_id'";
